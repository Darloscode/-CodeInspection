                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-logout">POST api/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-citas--id-">
                                <a href="#endpoints-GETapi-citas--id-">GET api/citas/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-citas-paciente--id-">
                                <a href="#endpoints-GETapi-citas-paciente--id-">GET api/citas/paciente/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-citas-entreFechas--fechaInicio---fechaFin-">
                                <a href="#endpoints-GETapi-citas-entreFechas--fechaInicio---fechaFin-">GET api/citas/entreFechas/{fechaInicio}/{fechaFin}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-citas-profesional--profesionalId-">
                                <a href="#endpoints-GETapi-citas-profesional--profesionalId-">GET api/citas/profesional/{profesionalId}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-citas-estado--estado-">
                                <a href="#endpoints-GETapi-citas-estado--estado-">GET api/citas/estado/{estado}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-historiaClinica-paciente--pacienteId-">
                                <a href="#endpoints-GETapi-historiaClinica-paciente--pacienteId-">GET api/historiaClinica/paciente/{pacienteId}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-citas">
                                <a href="#endpoints-POSTapi-citas">POST api/citas</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-citas--id-">
                                <a href="#endpoints-PUTapi-citas--id-">PUT api/citas/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-pagos-paciente--id-">
                                <a href="#endpoints-GETapi-pagos-paciente--id-">GET api/pagos/paciente/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-pagos-cita--citaId-">
                                <a href="#endpoints-GETapi-pagos-cita--citaId-">GET api/pagos/cita/{citaId}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-pagos-estado--estado-">
                                <a href="#endpoints-GETapi-pagos-estado--estado-">GET api/pagos/estado/{estado}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-pagos-servicio--servicioId-">
                                <a href="#endpoints-GETapi-pagos-servicio--servicioId-">GET api/pagos/servicio/{servicioId}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-pagos">
                                <a href="#endpoints-POSTapi-pagos">POST api/pagos</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-citas--id-">GET api/citas/{id}</h2>
...
<p>The ID of the cita. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-citas-paciente--id-">GET api/citas/paciente/{id}</h2>
...
<span id="example-requests-GETapi-citas-paciente--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-citas-paciente--id-">
            <blockquote>
...
<span id="execution-results-GETapi-citas-paciente--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-citas-paciente--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-citas-paciente--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-citas-paciente--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-citas-paciente--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-citas-paciente--id-" data-method="GET"
      data-path="api/citas/paciente/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-citas-paciente--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-citas-paciente--id-"
                    onclick="tryItOut('GETapi-citas-paciente--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-citas-paciente--id-"
                    onclick="cancelTryOut('GETapi-citas-paciente--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-citas-paciente--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/citas/paciente/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-citas-paciente--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-citas-paciente--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the paciente. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-citas-entreFechas--fechaInicio---fechaFin-">GET api/citas/entreFechas/{fechaInicio}/{fechaFin}</h2>
...
<span id="example-requests-GETapi-citas-entreFechas--fechaInicio---fechaFin-">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-citas-entreFechas--fechaInicio---fechaFin-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-citas-entreFechas--fechaInicio---fechaFin-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-citas-entreFechas--fechaInicio---fechaFin-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-citas-entreFechas--fechaInicio---fechaFin-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-citas-entreFechas--fechaInicio---fechaFin-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-citas-entreFechas--fechaInicio---fechaFin-" data-method="GET"
      data-path="api/citas/entreFechas/{fechaInicio}/{fechaFin}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-citas-entreFechas--fechaInicio---fechaFin-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-citas-entreFechas--fechaInicio---fechaFin-"
                    onclick="tryItOut('GETapi-citas-entreFechas--fechaInicio---fechaFin-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-citas-entreFechas--fechaInicio---fechaFin-"
                    onclick="cancelTryOut('GETapi-citas-entreFechas--fechaInicio---fechaFin-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-citas-entreFechas--fechaInicio---fechaFin-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/citas/entreFechas/{fechaInicio}/{fechaFin}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-citas-entreFechas--fechaInicio---fechaFin-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-citas-entreFechas--fechaInicio---fechaFin-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-citas-profesional--profesionalId-">GET api/citas/profesional/{profesionalId}</h2>
...
<span id="example-requests-GETapi-citas-profesional--profesionalId-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-citas-profesional--profesionalId-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-citas-profesional--profesionalId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-citas-profesional--profesionalId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-citas-profesional--profesionalId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-citas-profesional--profesionalId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-citas-profesional--profesionalId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-citas-profesional--profesionalId-" data-method="GET"
      data-path="api/citas/profesional/{profesionalId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-citas-profesional--profesionalId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-citas-profesional--profesionalId-"
                    onclick="tryItOut('GETapi-citas-profesional--profesionalId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-citas-profesional--profesionalId-"
                    onclick="cancelTryOut('GETapi-citas-profesional--profesionalId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-citas-profesional--profesionalId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/citas/profesional/{profesionalId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-citas-profesional--profesionalId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-citas-profesional--profesionalId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-citas-estado--estado-">GET api/citas/estado/{estado}</h2>
...
<span id="example-requests-GETapi-citas-estado--estado-">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-citas-estado--estado-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-citas-estado--estado-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-citas-estado--estado-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-citas-estado--estado-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-citas-estado--estado-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-citas-estado--estado-" data-method="GET"
      data-path="api/citas/estado/{estado}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-citas-estado--estado-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-citas-estado--estado-"
                    onclick="tryItOut('GETapi-citas-estado--estado-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-citas-estado--estado-"
                    onclick="cancelTryOut('GETapi-citas-estado--estado-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-citas-estado--estado-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/citas/estado/{estado}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-citas-estado--estado-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-citas-estado--estado-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The estado. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-historiaClinica-paciente--pacienteId-">GET api/historiaClinica/paciente/{pacienteId}</h2>
...
<span id="example-requests-GETapi-historiaClinica-paciente--pacienteId-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-historiaClinica-paciente--pacienteId-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-historiaClinica-paciente--pacienteId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-historiaClinica-paciente--pacienteId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-historiaClinica-paciente--pacienteId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-historiaClinica-paciente--pacienteId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-historiaClinica-paciente--pacienteId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-historiaClinica-paciente--pacienteId-" data-method="GET"
      data-path="api/historiaClinica/paciente/{pacienteId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-historiaClinica-paciente--pacienteId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-historiaClinica-paciente--pacienteId-"
                    onclick="tryItOut('GETapi-historiaClinica-paciente--pacienteId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-historiaClinica-paciente--pacienteId-"
                    onclick="cancelTryOut('GETapi-historiaClinica-paciente--pacienteId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-historiaClinica-paciente--pacienteId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/historiaClinica/paciente/{pacienteId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-historiaClinica-paciente--pacienteId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-historiaClinica-paciente--pacienteId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>pacienteId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-citas">POST api/citas</h2>
...
<span id="example-requests-POSTapi-citas">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-citas">
</span>
<span id="execution-results-POSTapi-citas" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-citas"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-citas"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-citas" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-citas">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-citas" data-method="POST"
      data-path="api/citas"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-citas', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-citas"
                    onclick="tryItOut('POSTapi-citas');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-citas"
                    onclick="cancelTryOut('POSTapi-citas');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-citas"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-citas"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-citas"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
        ...
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>cedulaPaciente</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-citas--id-">PUT api/citas/{id}</h2>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-pagos-paciente--id-">GET api/pagos/paciente/{id}</h2>
...
<span id="example-requests-GETapi-pagos-paciente--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-pagos-paciente--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-pagos-paciente--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-pagos-paciente--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-pagos-paciente--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-pagos-paciente--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-pagos-paciente--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-pagos-paciente--id-" data-method="GET"
      data-path="api/pagos/paciente/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-pagos-paciente--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-pagos-paciente--id-"
                    onclick="tryItOut('GETapi-pagos-paciente--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-pagos-paciente--id-"
                    onclick="cancelTryOut('GETapi-pagos-paciente--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-pagos-paciente--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/pagos/paciente/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-pagos-paciente--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-pagos-paciente--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the paciente. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-pagos-cita--citaId-">GET api/pagos/cita/{citaId}</h2>
...
<span id="example-requests-GETapi-pagos-cita--citaId-">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-pagos-cita--citaId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-pagos-cita--citaId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-pagos-cita--citaId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-pagos-cita--citaId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-pagos-cita--citaId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-pagos-cita--citaId-" data-method="GET"
      data-path="api/pagos/cita/{citaId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-pagos-cita--citaId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-pagos-cita--citaId-"
                    onclick="tryItOut('GETapi-pagos-cita--citaId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-pagos-cita--citaId-"
                    onclick="cancelTryOut('GETapi-pagos-cita--citaId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-pagos-cita--citaId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/pagos/cita/{citaId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-pagos-cita--citaId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-pagos-cita--citaId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>citaId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-pagos-estado--estado-">GET api/pagos/estado/{estado}</h2>
...
<span id="example-requests-GETapi-pagos-estado--estado-">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-pagos-estado--estado-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-pagos-estado--estado-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-pagos-estado--estado-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-pagos-estado--estado-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-pagos-estado--estado-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-pagos-estado--estado-" data-method="GET"
      data-path="api/pagos/estado/{estado}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-pagos-estado--estado-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-pagos-estado--estado-"
                    onclick="tryItOut('GETapi-pagos-estado--estado-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-pagos-estado--estado-"
                    onclick="cancelTryOut('GETapi-pagos-estado--estado-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-pagos-estado--estado-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/pagos/estado/{estado}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-pagos-estado--estado-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-pagos-estado--estado-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The estado. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-pagos-servicio--servicioId-">GET api/pagos/servicio/{servicioId}</h2>
...
<span id="example-requests-GETapi-pagos-servicio--servicioId-">
<blockquote>Example request:</blockquote>
...
<span id="execution-results-GETapi-pagos-servicio--servicioId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-pagos-servicio--servicioId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-pagos-servicio--servicioId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-pagos-servicio--servicioId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-pagos-servicio--servicioId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-pagos-servicio--servicioId-" data-method="GET"
      data-path="api/pagos/servicio/{servicioId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-pagos-servicio--servicioId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-pagos-servicio--servicioId-"
                    onclick="tryItOut('GETapi-pagos-servicio--servicioId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-pagos-servicio--servicioId-"
                    onclick="cancelTryOut('GETapi-pagos-servicio--servicioId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-pagos-servicio--servicioId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/pagos/servicio/{servicioId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-pagos-servicio--servicioId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-pagos-servicio--servicioId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>servicioId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-pagos">POST api/pagos</h2>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-pagos--id-">PUT api/pagos/{id}</h2>
